        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-indigo-900 mb-4">
              Vishwanath Sports Meet 2024
            </h1>
            <p className="text-gray-600 text-lg">
              Join us for an exciting sports event that brings together young athletes
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-indigo-600 text-white py-3 px-6 rounded-lg hover:bg-indigo-700 transition-colors duration-200 font-semibold text-lg"
              >
                Register Now
              </button>
            </form>
